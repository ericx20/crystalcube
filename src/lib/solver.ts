...
export function solveEOCross(scramble: MoveSeq): MoveSeq | null {
  return solve(scramble, "EOCross")
}

export function solveEOLine(scramble: MoveSeq): MoveSeq | null {
  return solve(scramble, "EOLine")
}

const testScram = "R2 U' F2 U2 L2 B2 U' F2 R2 D' F2 L' U' L2 B F D L D' U2".split(" ") as MoveSeq
