import { Perm, Puzzle } from "src/libv2/types";
...
export const V_MASK: PyraMask = {
  solvedFaceletIndices: [
    0, 1, 9, 10, 11, 12, 18, 19, 20, 21, 22, 24, 25, 26,
...
const BASIC_MOVE_PERMS: { [l in Layer]: Perm} = {
  "R": [[17, 34], [18, 30], [19, 29], [16, 19], [24, 18], [23, 17], [29, 16], [30, 24], [34, 23], [25, 26], [26, 31], [31, 25]],
  "U": [[2, 17], [3, 7], [13, 8], [17, 14], [7, 15], [8, 16], [14, 2], [15, 3], [16, 13], [4, 6], [6, 5], [5, 4]],
  "L": [[11, 14], [12, 22], [13, 23], [14, 29], [22, 28], [23, 32], [29, 11], [28, 12], [32, 13], [20, 21], [21, 27], [27, 20]],
  "B": [[8, 11], [9, 1], [19, 2], [11, 34], [1, 33], [2, 32], [32, 19], [33, 9], [34, 8], [10, 0], [0, 35], [35, 10]],
}
const { R, U, L, B } = BASIC_MOVE_PERMS;
const Rv: Perm = [
  ...R,
  [21, 6], [22, 7], [14, 8], [15, 9], [5, 10], [6, 35], [7, 33], [8, 32], [9, 28], [10, 27], [35, 21], [33, 22], [32, 14], [28, 15], [27, 5],
  [20, 4], [12, 3], [13, 2], [3, 1], [4, 0], [2, 11], [1, 12], [0, 20], [11, 13],
];
const Uv: Perm = [
  ...U,
  ...invertPerm([[0, 21], [1, 22], [11, 23], [12, 24], [20, 25], [21, 26], [22, 18], [23, 19], [24, 9], [25, 10],
  [26, 0], [18, 1], [19, 11], [9, 12], [10, 20],
  [27, 31], [28, 30], [29, 34], [30, 33], [31, 35], [34, 32], [33, 28], [35, 27], [32, 29]
  ]),
];
const MOVE_PERMS = {
  R,
