...
export default function SelectLevel({
  ...
  const { nMoveScrambleConfig, isEOStep } = SOLVER_CONFIGS[solverName];
  return (
    <TrainerCard>
      ...
      >
        <HStack spacing={4}>
          ...
          {isEOStep && <Radio value="nFlip"># of bad edges</Radio>}|
          <Radio value="nMove"># of moves</Radio>
        </HStack>
      </RadioGroup>
      {isNFlipMode && <SelectNFlip nFlip={nFlip} onSelectNFlip={setNFlip} />}
      {isNMoveMode && (
        <SelectNMove
